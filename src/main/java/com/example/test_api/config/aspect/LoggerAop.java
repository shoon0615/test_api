package com.example.test_api.config.aspect;
...
public class LoggerAop {
    ...
    // @Before("execution(* com.example.test_api.test.in.controller..*Controller.Rest*(..))")  // Like '%Controller' IN 'Rest%'
    @Around("execution(* com.example.test_api.test..*(..)) || execution(* com.example.test_api.web..*(..))")     // 전체
    ...
    @Pointcut("@annotation(com.example.test_api.config.aspect.Timer)")   // @Timer 어노테이션 설정한 메소드
